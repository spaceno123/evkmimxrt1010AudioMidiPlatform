...
#define USB_MIDI_CONTROL_INTERFACE_HEADER_LENGTH    (9)
#define USB_MIDI_STREAM_INTERFACE_HEADER_LENGTH     (7)
...
#define USB_AUDIO_MIDI_CONTROL_INTERFACE_INDEX    (3)
#define USB_AUDIO_MIDI_STREAM_INTERFACE_INDEX     (4)
...
#define USB_MIDI_INTERFACE_COUNT (2U)

#define USB_MIDI_IN_BUFFER_LENGTH  (512U)
#define USB_MIDI_OUT_BUFFER_LENGTH (512U)
#define USB_MIDI_ENDPOINT_COUNT    (2U)
#define USB_MIDI_INTERFACE_INDEX   (3U)
#define USB_MIDI_ENDPOINT_IN       (4U)
#define USB_MIDI_ENDPOINT_OUT      (4U)

#define USB_MIDI_INTERFACE_ALTERNATE_COUNT (1)
#define USB_MIDI_CONTROL_INTERFACE_ALTERNATE_0    (0U)
#define USB_MIDI_STREAM_INTERFACE_ALTERNATE_0     (0U)
...
#endif
#define USB_AUDIO_CONTROL_ENDPOINT_COUNT         (0)
...
#define USB_AUDIO_MIDI_STREAM_ENDPOINT     (4)
...
#define USB_MIDI_STREAM_INTERFACE_COUNT           (1)
...
#define AUDIO_OUT_FORMAT_BITS     (24)//(16)
#define AUDIO_OUT_FORMAT_SIZE     (0x03)//(0x02)
#define AUDIO_IN_FORMAT_CHANNELS  (0x02U)
#define AUDIO_IN_FORMAT_BITS      (24)//(16)
#define AUDIO_IN_FORMAT_SIZE      (0x03)//(0x02)
...
#endif
#endif
#define HS_MIDI_BULK_OUT_PACKET_SIZE (512U)
#define FS_MIDI_BULK_OUT_PACKET_SIZE (64U)
#define HS_MIDI_BULK_OUT_INTERVAL    (0x00U)	//?(0x04U) /* 2^(4-1) = 1ms */
#define FS_MIDI_BULK_OUT_INTERVAL    (0x00U)	//?(0x01U)

#define HS_MIDI_BULK_IN_PACKET_SIZE (512U)
#define FS_MIDI_BULK_IN_PACKET_SIZE (64U)
#define HS_MIDI_BULK_IN_INTERVAL    (0x00U)	//?(0x04U) /* 2^(4-1) = 1ms */
#define FS_MIDI_BULK_IN_INTERVAL    (0x00U)	//?(0x01U)
...
/* Class code. */
#if (USB_DEVICE_CONFIG_AUDIO_CLASS_2_0)
#define USB_DEVICE_CLASS    (0xEF) //(0x00)
#define USB_DEVICE_SUBCLASS (0x02) //(0x00)
#define USB_DEVICE_PROTOCOL (0x01) //(0x00)
#else
...
#endif
#define USB_MIDI_PROTOCOL         (0x00U)
...
#define USB_AUDIO_RECORDER_CONTROL_OUTPUT_TERMINAL_ID (0x02)//(0x03)

#define USB_AUDIO_SPEAKER_CONTROL_INPUT_TERMINAL_ID  (0x03)//(0x04)
//#define USB_AUDIO_SPEAKER_CONTROL_FEATURE_UNIT_ID    (0x05)
#define USB_AUDIO_SPEAKER_CONTROL_OUTPUT_TERMINAL_ID (0x04)//(0x06)
