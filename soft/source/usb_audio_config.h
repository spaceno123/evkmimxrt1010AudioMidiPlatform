...
#define AUDIO_SPEAKER_DATA_WHOLE_BUFFER_COUNT \
    (4U)//(2U) /* 2 units size buffer (1 unit means the size to play during 1ms) */
#else
#define AUDIO_CLASS_2_0_HS_LOW_LATENCY_TRANSFER_COUNT \
...
#define AUDIO_SPEAKER_DATA_WHOLE_BUFFER_COUNT_NORMAL  (4)//(16)//(16 * 2)
#define AUDIO_RECORDER_DATA_WHOLE_BUFFER_COUNT_NORMAL (4)//(16)//(16 * 2)
