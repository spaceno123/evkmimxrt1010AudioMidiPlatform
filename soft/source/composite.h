...
typedef struct _usb_device_composite_struct
{
    ...
    usb_device_audio_midi_struct_t midiStream;
...
#define MIDITXREQBIT        (0)	// for USB TX(in) end
#define MIDIRXREQBIT        (1)	// for USB RX(out) end
#define MIDITXREMAINREQBIT  (2)	// for TX remain
#define AUDIOOUTRESETREQBIT (3)
...
/*!
 * @brief MIDI class specific callback function.
 *
 * This function handles the MIDI class specific requests.
 *
 * @param handle		  The MIDI class handle.
 * @param event 		  The MIDI class event type.
 * @param param 		  The parameter of the class specific request.
 *
 * @return A USB error code or kStatus_USB_Success.
 */
 ...
 * @return A USB error code or kStatus_USB_Success.
 */
extern usb_status_t USB_DeviceMidiSetConfigure(class_handle_t handle, uint8_t configure);

/*!
 * @brief MIDI device initialization function.
 *
 * This function initializes the device with the composite device class information.
 *
 * @param device_composite The pointer to the composite device structure.
 ...
 * @return A USB error code or kStatus_USB_Success.
 */
extern usb_status_t USB_DeviceMidiStreamInit(usb_device_composite_struct_t *device_composite);

/*!
 * @brief APP Task wake up function.
 */
extern void APPTaskWup(uint32_t bitPattern);
