...
usb_device_endpoint_struct_t g_UsbDeviceMidiEndpoints[USB_MIDI_ENDPOINT_COUNT] = {
    /* MIDI bulk IN pipe */
    {
        USB_MIDI_ENDPOINT_IN | (USB_IN << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT),
        USB_ENDPOINT_BULK,
        FS_MIDI_BULK_IN_PACKET_SIZE,
        FS_MIDI_BULK_IN_INTERVAL,
    },
    /* MIDI bulk OUT pipe */
    {
        USB_MIDI_ENDPOINT_OUT | (USB_OUT << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT),
        USB_ENDPOINT_BULK,
        FS_MIDI_BULK_OUT_PACKET_SIZE,
        FS_MIDI_BULK_OUT_INTERVAL,
    }};

/* MIDI interface information */
usb_device_interface_struct_t g_UsbDeviceMidiInterface[] = {
    {
        USB_MIDI_CONTROL_INTERFACE_ALTERNATE_0, /* The alternate setting of the interface */
        {
            USB_MIDI_ENDPOINT_COUNT,  /* Endpoint count */
            g_UsbDeviceMidiEndpoints, /* Endpoints handle */
        },
        NULL,
    }
};

usb_device_interfaces_struct_t g_UsbDeviceMidiInterfaces[1] = {
    {
        USB_AUDIO_CLASS,                 /* Audio class code */
        USB_SUBCLASS_MIDISTREAM,         /* MIDI subclass code */
        USB_MIDI_PROTOCOL,               /* MIDI protocol code */
		USB_MIDI_STREAM_INTERFACE_INDEX, /* The interface number of the MIDI */
        g_UsbDeviceMidiInterface,        /* Interfaces handle */
        sizeof(g_UsbDeviceMidiInterface) / sizeof(usb_device_interface_struct_t),
    },
};

usb_device_interface_list_t g_UsbDeviceMidiInterfaceList[USB_DEVICE_CONFIGURATION_COUNT] = {
    {
        1 ,                        /* The interface count of the MIDI */
        g_UsbDeviceMidiInterfaces, /* The interfaces handle */
    },
};

usb_device_class_struct_t g_UsbDeviceMidiClass = {
    g_UsbDeviceMidiInterfaceList,       /* The interface list of the MIDI */
    kUSB_DeviceClassTypeMidi,           /* The MIDI class type */
...
usb_device_interface_struct_t g_UsbDeviceAudioRecorderControInterface[] = {{
    USB_AUDIO_CONTROL_INTERFACE_ALTERNATE_0,
    {
        ...
        NULL,//g_UsbDeviceAudioControlEndpoints,
    },
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_SHORT_GET_LOW(USB_DESCRIPTOR_LENGTH_CONFIGURE + 0x08U + USB_DESCRIPTOR_LENGTH_INTERFACE +
                      ...
                      USB_AUDIO_CLOCK_SOURCE_LENGTH + 0x11U + 0x0CU + +0x11U + 0x0CU +
					  ...
					  + USB_DESCRIPTOR_LENGTH_INTERFACE + 0x41U
					  ),
    ...
    */
    ...
    0x53, 0x00U,  /* Total number of bytes returned for the class-specific
	...
	USB_AUDIO_RECORDER_CONTROL_INPUT_TERMINAL_ID,//USB_AUDIO_RECORDER_CONTROL_FEATURE_UNIT_ID, /* ID of the Unit or Terminal to which this Terminal is connected.  */
    ...
    0x00U,        /* This Output Terminal has no association  */
	USB_AUDIO_SPEAKER_CONTROL_INPUT_TERMINAL_ID,//USB_AUDIO_SPEAKER_CONTROL_FEATURE_UNIT_ID, /* ID of the Unit or Terminal to which this Terminal is connected.  */
	...
	AUDIO_IN_FORMAT_BITS,    /* The number of effectively used bits from the available bits in an audio subslot   */
    ...
    0x08U,                                     /* Descriptor size is 8 bytes  */
    USB_DESCRIPTOR_TYPE_INTERFACE_ASSOCIATION, /* INTERFACE_ASSOCIATION Descriptor Type   */
    0x03U,                                     /* The first interface number associated with this function is 0   */
    0x02U,                     /* The number of contiguous interfaces associated with this function is 2   */
    USB_AUDIO_CLASS,           /* The function belongs to the Audio Interface Class  */
	USB_SUBCLASS_AUDIOCONTROL, /* The function belongs to the AUDIOCONTROL Subclass  */
    0x00U,                     /* Protocol code = 0   */
    0x00U,                     /* The Function string descriptor index is 0  */

    USB_DESCRIPTOR_LENGTH_INTERFACE,         /* Size of the descriptor, in bytes  */
    USB_DESCRIPTOR_TYPE_INTERFACE,           /* INTERFACE Descriptor Type   */
	USB_MIDI_CONTROL_INTERFACE_INDEX,        /* The number of this interface is 0 */
    USB_MIDI_CONTROL_INTERFACE_ALTERNATE_0,  /* The value used to select the alternate setting for this interface is 0
                                              */
    0x00U,                     /* The number of endpoints used by this interface is 0 (excluding endpoint zero)   */
    USB_AUDIO_CLASS,           /* The interface implements the Audio Interface class   */
    USB_SUBCLASS_AUDIOCONTROL, /* The interface implements the AUDIOCONTROL Subclass   */
    0x00U,                     /* The Protocol code is 0 ?   */
    0x00U,                     /* The interface string descriptor index is 2  */

    USB_MIDI_CONTROL_INTERFACE_HEADER_LENGTH,    /* Size of the descriptor, in bytes  */
    USB_DESCRIPTOR_TYPE_MIDI_CS_INTERFACE,       /* CS_INTERFACE Descriptor Type   */
    USB_DESCRIPTOR_SUBTYPE_AUDIO_CONTROL_HEADER, /* HEADER descriptor subtype  */
    0x00U, 0x01U, /* Audio Device compliant to the USB Audio specification version 1.00  */
    0x09U, 0x00U, /* Total number of bytes returned for the class-specific
                     AudioControl interface descriptor. Includes the combined length of this descriptor header and all
                     Unit and Terminal descriptors.   */
    0x01U,        /* Number of streaming interface.   */
	USB_AUDIO_MIDI_STREAM_INTERFACE_INDEX, /* MIDIStreaming interface 1 belongs to this AudioControl interface.  */

    USB_DESCRIPTOR_LENGTH_INTERFACE,       /* Size of the descriptor, in bytes  */
    USB_DESCRIPTOR_TYPE_INTERFACE,         /* INTERFACE Descriptor Type   */
	USB_MIDI_STREAM_INTERFACE_INDEX,       /* The number of this interface is 0 */
    USB_MIDI_STREAM_INTERFACE_ALTERNATE_0, /* The value used to select the alternate setting for this interface is 0
                                              */
	USB_MIDI_ENDPOINT_COUNT, /* The number of endpoints used by this interface is 2  */
    USB_AUDIO_CLASS,         /* The interface implements the Audio Interface class   */
	USB_SUBCLASS_MIDISTREAM, /* The interface implements the MIDISTREAM Subclass   */
    0x00U,                   /* The Protocol code is 0 ?   */
    0x00U,                   /* The interface string descriptor index is 2  */

    USB_MIDI_STREAM_INTERFACE_HEADER_LENGTH,     /* Size of the descriptor, in bytes  */
    USB_DESCRIPTOR_TYPE_MIDI_CS_INTERFACE,       /* CS_INTERFACE Descriptor Type   */
	USB_DESCRIPTOR_SUBTYPE_MS_HEADER,            /* HEADER descriptor subtype  */
    0x00U, 0x01U, /* Audio Device compliant to the USB Audio specification version 1.00  */
    0x41U, 0x00U, /* Total number of bytes returned for the class-specific
                     AudioControl interface descriptor. Includes the combined length of this descriptor header and all
                     Unit and Terminal descriptors.   */

	0x06U,                                       /* Size of the descriptor, in bytes  */
    USB_DESCRIPTOR_TYPE_MIDI_CS_INTERFACE,       /* CS_INTERFACE Descriptor Type   */
	USB_DESCRIPTOR_SUBTYPE_MS_MIDI_IN_JACK,      /* MIDI_IN_JACK subtype. */
	USB_DESCRIPTOR_TYPE_MS_EMBEDDED,             /* EMBEDDED. */
	0x01U,                                       /* ID of this Jack. */
	0x00U,                                       /* Unused. */

	0x06U,                                       /* Size of the descriptor, in bytes  */
    USB_DESCRIPTOR_TYPE_MIDI_CS_INTERFACE,       /* CS_INTERFACE Descriptor Type   */
	USB_DESCRIPTOR_SUBTYPE_MS_MIDI_IN_JACK,      /* MIDI_IN_JACK subtype. */
	USB_DESCRIPTOR_TYPE_MS_EXTERNAL,             /* EXTERNAL. */
	0x02U,                                       /* ID of this Jack. */
	0x00U,                                       /* Unused. */

	0x09U,                                       /* Size of the descriptor, in bytes  */
    USB_DESCRIPTOR_TYPE_MIDI_CS_INTERFACE,       /* CS_INTERFACE Descriptor Type   */
	USB_DESCRIPTOR_SUBTYPE_MS_MIDI_OUT_JACK,     /* MIDI_OUT_JACK subtype. */
	USB_DESCRIPTOR_TYPE_MS_EMBEDDED,             /* EMBEDDED. */
	0x03U,                                       /* ID of this Jack. */
	0x01U,                                       /* Number of Input Pins of this Jack. */
	0x02U,                                       /* ID of the Entity to which this Pin is connected. */
	0x01U,                                       /* Output Pin number of the Entity to which this Input Pin is connected. */
	0x00U,                                       /* Unused. */
	...
	USB_DESCRIPTOR_SUBTYPE_MS_MIDI_OUT_JACK,     /* MIDI_OUT_JACK subtype. */
	USB_DESCRIPTOR_TYPE_MS_EXTERNAL,             /* EXTERNAL. */
	0x04U,                                       /* ID of this Jack. */
	0x01U,                                       /* Number of Input Pins of this Jack. */
	0x01U,                                       /* ID of the Entity to which this Pin is connected. */
	0x01U,                                       /* Output Pin number of the Entity to which this Input Pin is connected. */
	0x00U,                                       /* Unused. */
	...
	USB_MIDI_ENDPOINT_OUT |
	    (USB_OUT << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT), /* OUT Endpoint 4. */
	0x02U,                                       /* Bulk, not shared. */
	0x40U,0x00U,                                 /* 64 bytes per packet. */
	0x00U,                                       /* Ignored for Bulk. Set to zero. */
	0x00U,                                       /* Unused. */
	0x00U,                                       /* Unused. */

	0x05U,                                       /* Size of the descriptor, in bytes  */
	USB_DESCRIPTOR_TYPE_MIDI_CS_ENDPOINT,        /* CS_ENDPOINT descriptor */
	USB_DESCRIPTOR_SUBTYPE_MS_GENERAL,           /* MS_GENERAL subtype. */
	0x01U,                                       /* Number of embedded MIDI IN Jacks. */
	0x01U,                                       /* ID of the Embedded MIDI IN Jack. */

	0x09U,                                       /* Size of the descriptor, in bytes  */
	USB_DESCRIPTOR_TYPE_ENDPOINT,                /* ENDPOINT descriptor. */
	USB_MIDI_ENDPOINT_IN |
        (USB_IN << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT), /* IN Endpoint 1. */
	0x02U,                                       /* Bulk, not shared. */
	0x40U,0x00U,                                 /* 64 bytes per packet. */
	0x00U,                                       /* Ignored for Bulk. Set to zero. */
	0x00U,                                       /* Unused. */
	...
	USB_DESCRIPTOR_TYPE_MIDI_CS_ENDPOINT,        /* CS_ENDPOINT descriptor */
	USB_DESCRIPTOR_SUBTYPE_MS_GENERAL,           /* MS_GENERAL subtype. */
	0x01U,                                       /* Number of embedded MIDI OUT Jacks. */
	0x03U,                                       /* ID of the Embedded MIDI OUT Jack. */
#else
    USB_DESCRIPTOR_LENGTH_CONFIGURE, /* Size of this descriptor in bytes */
    USB_DESCRIPTOR_TYPE_CONFIGURE,   /* CONFIGURATION Descriptor Type */
    USB_SHORT_GET_LOW(
    ...
    */
    ...
    USB_DESCRIPTOR_SUBTYPE_AUDIO_CONTROL_HEADER, /* HEADER descriptor subtype   */
    0x00U, 0x01U, /* Audio Device compliant to the USB Audio specification version 1.00  */
    0x34, 0x00U,  /* Total number of bytes returned for the class-specific AudioControl interface descriptor. Includes
...
usb_status_t USB_DeviceSetSpeed(usb_device_handle handle, uint8_t speed)
{
...
#endif
                else if ((USB_AUDIO_MIDI_STREAM_ENDPOINT ==
                		  (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)) &&
                		 ((descriptorHead->endpoint.bEndpointAddress >>
                		   USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT) == USB_OUT))
                {
                    descriptorHead->endpoint.bInterval = HS_MIDI_BULK_OUT_INTERVAL;
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_MIDI_BULK_OUT_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
                else if ((USB_AUDIO_MIDI_STREAM_ENDPOINT ==
                		  (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)) &&
                		 ((descriptorHead->endpoint.bEndpointAddress >>
                		   USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT) == USB_IN))
                {
                    descriptorHead->endpoint.bInterval = HS_MIDI_BULK_IN_INTERVAL;
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_MIDI_BULK_IN_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
                else
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(
                        ...
                        descriptorHead->endpoint.wMaxPacketSize);
                		 ...
                		 ((descriptorHead->endpoint.bEndpointAddress >>
                		   USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT) == USB_OUT))
                {
                    descriptorHead->endpoint.bInterval = FS_MIDI_BULK_OUT_INTERVAL;
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_MIDI_BULK_OUT_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
                else if ((USB_AUDIO_MIDI_STREAM_ENDPOINT ==
                		  (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)) &&
                		 ((descriptorHead->endpoint.bEndpointAddress >>
                		   USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT) == USB_IN))
                {
                    descriptorHead->endpoint.bInterval = FS_MIDI_BULK_IN_INTERVAL;
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_MIDI_BULK_IN_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
                else
                {
    ...
    for (int i = 0U; i < USB_MIDI_ENDPOINT_COUNT; i++)
    {
        if (USB_SPEED_HIGH == speed)
        {
            if (g_UsbDeviceMidiEndpoints[i].endpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK)
            {
                g_UsbDeviceMidiEndpoints[i].maxPacketSize = HS_MIDI_BULK_IN_PACKET_SIZE;
                g_UsbDeviceMidiEndpoints[i].interval      = HS_MIDI_BULK_IN_INTERVAL;
            }
            else
            {
                g_UsbDeviceMidiEndpoints[i].maxPacketSize = HS_MIDI_BULK_OUT_PACKET_SIZE;
                g_UsbDeviceMidiEndpoints[i].interval      = HS_MIDI_BULK_OUT_INTERVAL;
            }
        }
        else
        {
            if (g_UsbDeviceMidiEndpoints[i].endpointAddress & USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK)
            {
                g_UsbDeviceMidiEndpoints[i].maxPacketSize = FS_MIDI_BULK_IN_PACKET_SIZE;
                g_UsbDeviceMidiEndpoints[i].interval      = FS_MIDI_BULK_IN_INTERVAL;
            }
            else
            {
                g_UsbDeviceMidiEndpoints[i].maxPacketSize = FS_MIDI_BULK_OUT_PACKET_SIZE;
                g_UsbDeviceMidiEndpoints[i].interval      = FS_MIDI_BULK_OUT_INTERVAL;
            }
        }
    }
